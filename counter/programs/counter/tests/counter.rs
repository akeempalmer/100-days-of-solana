...
#[test]
// fn initalize_sets_count_to_zero() {
...
//     svm.send_transaction(tx).expect("initialize should success");
...
fn increment_fails_when_wrong_authority_signs() {
    ...
    // authority_a creates the counter. This must succedd.
    ...
    svm.send_transaction(init_tx).expect("initalize should succeed");
...
fn initialize_fails_when_counter_already_exists() {
    ...
    svm.send_transaction(first_tx).expect("first initalize should succeed");
